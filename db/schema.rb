...
ActiveRecord::Schema.define(version: 20170301033802) do
  ...
  add_index "project_tags", ["tag_id", "project_id"], name: "index_project_tags_on_tag_id_and_project_id"
  ...
  add_index "tags", ["text", "user_id"], name: "index_tags_on_text_and_user_id"
